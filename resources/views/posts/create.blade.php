        ...
        <form action="{{ route('posts.store') }}" method="post">
            ...
            <form class="max-w-sm mx-auto">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" class="block w-full p-2.5 text-sm rounded-lg {{ $inputClassesTitle }}">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="slug" value="{{ old('slug') }}" class="text-sm rounded-lg block w-full p-2.5 {{ $inputClassesSlug}}">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="category" value="{{ old('category') }}" class="btext-sm rounded-lg block w-full p-2.5 {{ $inputClassesCategory}}">
                ...
                <div class="mb-5">
                    ...
                    <textarea name="content" class="btext-sm rounded-lg block w-full p-2.5 {{ $inputClassesContent}}">{{ old('content') }}</textarea>
                    @error('content')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                            <span class="font-medium">Oops!</span> {{ $message }}
                        </p>
